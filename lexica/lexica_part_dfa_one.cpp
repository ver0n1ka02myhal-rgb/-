...
#define TOKENS_RE         ";|:>|ADD|SUB|-|MUL|,|DIV|,|==|!=|\\[|\\]|\\(|\\)|\\{|\\}|!>|!<|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|:>|ADD|SUB|-|MUL|,|DIV|,|==|!=|\\[|\\]|\\(|\\)|\\{|\\}|#|PROGRAM|_R012|DATA|START|STOP|SCAN|PRINT|IF|ELSE|DO|WHILE|DIV|MOD|!>|!<|NOT|OR|AND|\\|\\||INTEGER16_t"
